...
export default function DecryptedText({ text, speed = 50, maxIterations = 10, sequential = false, revealDirection = 'start', useOriginalCharsOnly = false, characters = 'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz!@#$%^&*()_+', className = '', parentClassName = '', encryptedClassName = '', animateOn = 'hover', ...props }) {
    ...
    const hoverProps = animateOn === 'hover' || animateOn === 'both'
        ...
        : {};
    return (_jsxs(motion.span, { className: parentClassName, ref: containerRef, style: styles.wrapper, ...hoverProps, ...props, children: [_jsx("span", { style: styles.srOnly, children: displayText }), _jsx("span", { "aria-hidden": "true", children: displayText.split('').map((char, index) => {
                    const isRevealedOrDone = revealedIndices.has(index) || !isScrambling || !isHovering;
                    return (_jsx("span", { className: isRevealedOrDone ? className : encryptedClassName, children: char }, index));
                }) })] }));
}
